...
class Filter:
    ...
    def filter_local_files(self, files, unversioned):
        ...
        for _file in files:
            ...
            if status != 'unversioned' or unversioned:
                line = self.construct_line(filename, status, idx)
                idx = idx + 1
                lines.append(line)
        return lines
